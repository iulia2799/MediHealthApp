...
fun ContentR() {
    ...
    Column(modifier = Modifier
        ...
        Row{
            CustomTextField(text = firstName,labelValue = "First Name", onTextChange = { newValue ->
                firstName = newValue
            })
        ...
        Row{
            CustomElevatedButton(onClick = { scope.launch {
...
fun Register(context: Context, value: String){
